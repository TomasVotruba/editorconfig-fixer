...
use EditorconfigFixer202309\TomasVotruba\EditorconfigFixer\EditorConfig\IndentationFixer;
...
final class FixCommand extends Command
{
    ...
    /**
     * @readonly
     * @var \TomasVotruba\EditorconfigFixer\EditorConfig\IndentationFixer
     */
    ...
    public function __construct(PhpFilesFinder $phpFilesFinder, SymfonyStyle $symfonyStyle, IndentationFixer $indentationFixer, EditorConfigFactory $editorConfigFactory)
    {
        $this->phpFilesFinder = $phpFilesFinder;
        $this->symfonyStyle = $symfonyStyle;
        $this->indentationFixer = $indentationFixer;
