 ...
 */
namespace EditorconfigFixer202309\Composer;

use EditorconfigFixer202309\Composer\Autoload\ClassLoader;
use EditorconfigFixer202309\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('EditorconfigFixer202309\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
