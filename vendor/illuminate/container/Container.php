...
namespace EditorconfigFixer202309\Illuminate\Container;

use ArrayAccess;
use Closure;
use Exception;
use EditorconfigFixer202309\Illuminate\Contracts\Container\BindingResolutionException;
use EditorconfigFixer202309\Illuminate\Contracts\Container\CircularDependencyException;
use EditorconfigFixer202309\Illuminate\Contracts\Container\Container as ContainerContract;
use LogicException;
use ReflectionClass;
